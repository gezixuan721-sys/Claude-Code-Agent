...
from claude_code_agent.core.bus.envelope import HandlerError
from claude_code_agent.core.bus.events import (
    SessionClosedEvent,
    SessionCreatedEvent,
...
from claude_code_agent.core.session.model import Session, SessionMode
...
class SessionManager:
    ...
    async def compact(self, sid: str, focus: str = "") -> Any:
        ...
        async with lock:
            from claude_code_agent.core.bus.commands import SessionCompactResult
