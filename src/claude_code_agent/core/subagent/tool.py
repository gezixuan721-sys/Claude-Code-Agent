...
from claude_code_agent.core.agents.loader import AgentProfile, AgentProfileLoader
from claude_code_agent.core.bus.events import SubagentFinishedEvent, SubagentStartedEvent
...
from claude_code_agent.core.loop import AgentLoop
from claude_code_agent.core.runs import new_run_id
from claude_code_agent.core.subagent.registry import BackgroundTaskRegistry
from claude_code_agent.core.tools.base import BaseTool, ToolResult
from claude_code_agent.core.tools.builtin.bash import BashTool
from claude_code_agent.core.tools.builtin.list_dir import ListDirTool
from claude_code_agent.core.tools.builtin.read_file import ReadFileTool
from claude_code_agent.core.tools.builtin.task_create import TaskCreateTool
from claude_code_agent.core.tools.builtin.task_get import TaskGetTool
from claude_code_agent.core.tools.builtin.task_list import TaskListTool
from claude_code_agent.core.tools.builtin.task_update import TaskUpdateTool
from claude_code_agent.core.tools.builtin.write_file import WriteFileTool
from claude_code_agent.core.tools.registry import ToolRegistry

if TYPE_CHECKING:
    from claude_code_agent.core.llm.base import LLMProvider
...
class SpawnAgentTool(BaseTool):
    ...
    def _build_child_registry(
        ...
        from claude_code_agent.core.task.manager import TaskManager
