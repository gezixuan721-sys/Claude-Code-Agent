...
from claude_code_agent.core.bus.commands import (
    AgentRunCommand,
    AgentRunResult,
...
from claude_code_agent.core.permissions.storage import load_policy_file
from claude_code_agent.core.runner import AgentRunner
from claude_code_agent.core.runs import events_file, new_run_id
from claude_code_agent.core.session import SessionManager, SessionStore
from claude_code_agent.core.trace.record import TraceRecord
from claude_code_agent.core.trace.writer import TraceWriter
from claude_code_agent.core.transport.ipc_broadcaster import IpcEventBroadcaster
from claude_code_agent.core.transport.socket_server import SocketServer, get_connection_writer
...
class CoreApp:
    ...
    async def _ping_handler(self, params: dict[str, Any]) -> PongResult:
        ...
        return PongResult(
            server_version=claude_code_agent.__version__,
